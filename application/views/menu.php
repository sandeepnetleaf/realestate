              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li>
                    ...
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('auth/users');?>"><i class="fa fa-users"></i> List User</a></li>
                      <li><a href="#"><i class="fa fa-user-plus"></i> Add User</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Acer Admin <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Upload soft Bundles</a></li>
                      <li><a href="form_advanced.html">Upload hard Bundles</a></li>
                      <li><a href="form_validation.html">Create Offer</a></li>
                      <li><a href="form_wizards.html">Part Details</a></li>
                      <li><a href="form_upload.html">Offer Details</a></li>
                    </ul>
                  </li>
