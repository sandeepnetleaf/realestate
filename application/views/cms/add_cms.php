                                    ...
                                    <?=  form_open_multipart('cms/add_cms', array('id'=>'vFORM', 'class'=>'form-horizontal form-label-left'))?>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <?php echo form_dropdown($sd, $options, array('required'=>'required'));?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <?=form_textarea(['name'=>'cms_description', 'id'=>'cms_description', 'required'=>'required', 'placeholder'=>'CMS Description', 'class'=>'form-control ckeditor'], set_value('cms_description'));?>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <?php echo form_label('Status <span class="required">*</span>', 'cms_status', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12'));?>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="radio" name="cms_status" class="flat" id="cms_status" value="1" checked> Active
                                                <input type="radio" name="cms_status" class="flat" id="cms_status" value="0" > Inactive
                                            </div>
                                        </div>
