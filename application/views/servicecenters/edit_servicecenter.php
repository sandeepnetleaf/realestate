                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content"><br />
                                ...
                                <?php echo form_open_multipart('servicecenter/edit_servicecenter', array('id'=>'vFORM'));?>    
                                    ...
                                    <div class="row"> 
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <br/>
                                                <input type="checkbox" name="sc_working_days[]" id="sc_working_days1" value="1" checked>
                                                <?php echo form_label('Monday ', 'sc_working_days1', array('class' => 'control-label'));?>
                                                <input type="checkbox" name="sc_working_days[]" id="sc_working_days2" value="2" checked>
                                                <?php echo form_label('Tuesday ', 'sc_working_days2', array('class' => 'control-label'));?>
                                                <input type="checkbox" name="sc_working_days[]" id="sc_working_days3" value="3" checked>
                                                <?php echo form_label('Wednesday ', 'sc_working_days3', array('class' => 'control-label'));?>
                                                <input type="checkbox" name="sc_working_days[]" id="sc_working_days4" value="4" checked>
                                                <?php echo form_label('Thursday ', 'sc_working_days4', array('class' => 'control-label'));?>
                                                <input type="checkbox" name="sc_working_days[]" id="sc_working_days5" value="5" checked>
                                                <?php echo form_label('Friday ', 'sc_working_days5', array('class' => 'control-label'));?>
                                                <input type="checkbox" name="sc_working_days[]" id="sc_working_days6" value="6" checked>
                                                <?php echo form_label('Saturday ', 'sc_working_days6', array('class' => 'control-label'));?>
                                                <input type="checkbox" name="sc_working_days[]" id="sc_working_days7" value="7" checked>
						...
						<input type="radio" name="sc_status" class="flat" id="sc_status" value="2" > Inactive
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="sc_service_center" class="control-label"> </label>
