...
function form_ckeditors2($data)
{
    return  '<script type="text/javascript" src="'.base_url().'assets/build/js/ckeditor/ckeditor.js"></script>' .
...
function form_ckeditor($data)
{
    ...
    return 
    // fix: move to <HEAD...
    '< script type="text/javascript" src="'.base_url().'assets/build/js/ckeditor/ckeditor.js"></ script>' .
